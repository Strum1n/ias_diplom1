...
class FuzzyEvaluator:
    ...
    def create_family_system(self):
        ...
        total_rooms["few"] = fuzz.trimf(total_rooms.universe, [0, 0, 4])
        total_rooms["many"] = fuzz.trimf(total_rooms.universe, [1, 5, 5])
        ...
        rules = [
            ...
            ctrl.Rule(kindergarten_distance["close"] & school_distance["close"] & total_area["medium"] & total_rooms["few"], family_friendly["low"]),
            ...
            ctrl.Rule(kindergarten_distance["close"] & school_distance["medium"] & total_area["medium"] & total_rooms["few"], family_friendly["low"]),
            ...
            ctrl.Rule(kindergarten_distance["close"] & school_distance["far"] & total_area["large"] & total_rooms["few"], family_friendly["low"]),
            ctrl.Rule(kindergarten_distance["medium"] & school_distance["close"] & total_area["small"] & total_rooms["few"], family_friendly["low"]),
            ctrl.Rule(kindergarten_distance["medium"] & school_distance["close"] & total_area["medium"] & total_rooms["few"], family_friendly["low"]),
            ctrl.Rule(kindergarten_distance["medium"] & school_distance["close"] & total_area["large"] & total_rooms["few"], family_friendly["medium"]),
            ctrl.Rule(kindergarten_distance["medium"] & school_distance["medium"] & total_area["small"] & total_rooms["few"], family_friendly["low"]),
            ctrl.Rule(kindergarten_distance["medium"] & school_distance["medium"] & total_area["medium"] & total_rooms["few"], family_friendly["low"]),
            ctrl.Rule(kindergarten_distance["medium"] & school_distance["medium"] & total_area["large"] & total_rooms["few"], family_friendly["medium"]),
            ctrl.Rule(kindergarten_distance["medium"] & school_distance["far"] & total_area["small"] & total_rooms["few"], family_friendly["low"]),
            ctrl.Rule(kindergarten_distance["medium"] & school_distance["far"] & total_area["medium"] & total_rooms["few"], family_friendly["low"]),
            ctrl.Rule(kindergarten_distance["medium"] & school_distance["far"] & total_area["large"] & total_rooms["few"], family_friendly["low"]),
            ctrl.Rule(kindergarten_distance["far"] & school_distance["close"] & total_area["small"] & total_rooms["few"], family_friendly["low"]),
            ctrl.Rule(kindergarten_distance["far"] & school_distance["close"] & total_area["medium"] & total_rooms["few"], family_friendly["low"]),
            ctrl.Rule(kindergarten_distance["far"] & school_distance["close"] & total_area["large"] & total_rooms["few"], family_friendly["low"]),
            ...
            ctrl.Rule(kindergarten_distance["close"] & school_distance["close"] & total_area["small"] & total_rooms["many"], family_friendly["medium"]),
            ...
            ctrl.Rule(kindergarten_distance["close"] & school_distance["medium"] & total_area["medium"] & total_rooms["many"], family_friendly["medium"]),
            ctrl.Rule(kindergarten_distance["close"] & school_distance["medium"] & total_area["large"] & total_rooms["many"], family_friendly["high"]),
            ctrl.Rule(kindergarten_distance["close"] & school_distance["far"] & total_area["small"] & total_rooms["many"], family_friendly["low"]),
            ctrl.Rule(kindergarten_distance["close"] & school_distance["far"] & total_area["medium"] & total_rooms["many"], family_friendly["medium"]),
            ctrl.Rule(kindergarten_distance["close"] & school_distance["far"] & total_area["large"] & total_rooms["many"], family_friendly["medium"]),
            ctrl.Rule(kindergarten_distance["medium"] & school_distance["close"] & total_area["small"] & total_rooms["many"], family_friendly["medium"]),
            ctrl.Rule(kindergarten_distance["medium"] & school_distance["close"] & total_area["medium"] & total_rooms["many"], family_friendly["medium"]),
            ctrl.Rule(kindergarten_distance["medium"] & school_distance["close"] & total_area["large"] & total_rooms["many"], family_friendly["high"]),
            ctrl.Rule(kindergarten_distance["medium"] & school_distance["medium"] & total_area["small"] & total_rooms["many"], family_friendly["low"]),
            ctrl.Rule(kindergarten_distance["medium"] & school_distance["medium"] & total_area["medium"] & total_rooms["many"], family_friendly["medium"]),
            ctrl.Rule(kindergarten_distance["medium"] & school_distance["medium"] & total_area["large"] & total_rooms["many"], family_friendly["medium"]),
            ctrl.Rule(kindergarten_distance["medium"] & school_distance["far"] & total_area["small"] & total_rooms["many"], family_friendly["low"]),
            ctrl.Rule(kindergarten_distance["medium"] & school_distance["far"] & total_area["medium"] & total_rooms["many"], family_friendly["low"]),
            ctrl.Rule(kindergarten_distance["medium"] & school_distance["far"] & total_area["large"] & total_rooms["many"], family_friendly["medium"]),
            ctrl.Rule(kindergarten_distance["far"] & school_distance["close"] & total_area["small"] & total_rooms["many"], family_friendly["low"]),
            ctrl.Rule(kindergarten_distance["far"] & school_distance["close"] & total_area["medium"] & total_rooms["many"], family_friendly["medium"]),
            ctrl.Rule(kindergarten_distance["far"] & school_distance["close"] & total_area["large"] & total_rooms["many"], family_friendly["medium"]),
            ctrl.Rule(kindergarten_distance["far"] & school_distance["medium"] & total_area["small"] & total_rooms["many"], family_friendly["low"]),
            ctrl.Rule(kindergarten_distance["far"] & school_distance["medium"] & total_area["medium"] & total_rooms["many"], family_friendly["low"]),
            ctrl.Rule(kindergarten_distance["far"] & school_distance["medium"] & total_area["large"] & total_rooms["many"], family_friendly["medium"]),
            ctrl.Rule(kindergarten_distance["far"] & school_distance["far"] & total_area["small"] & total_rooms["many"], family_friendly["low"]),
            ctrl.Rule(kindergarten_distance["far"] & school_distance["far"] & total_area["medium"] & total_rooms["many"], family_friendly["low"]),
            ctrl.Rule(kindergarten_distance["far"] & school_distance["far"] & total_area["large"] & total_rooms["many"], family_friendly["low"]),
        ]
