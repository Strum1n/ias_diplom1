...
import { _ as _sfc_main$4 } from './Checkbox-DYXK6_Q4.mjs';
import { _ as _sfc_main$5 } from './Input-2RIsD9n3.mjs';
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const {
      ...
      refresh
    } = ([__temp, __restore] = withAsyncContext(() => useAsyncData("filterTypes", () => $api("/offers/filter_types"), {
      transform: (response) => ({
    ...
    const makeOptions = (key) => computed(() => filterTypes.value[key]?.map((t) => ({ label: t.name, value: t.id })) || []);
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "filters-content" }, _attrs))} data-v-051ce2d7><div class="filters-header" data-v-051ce2d7><p class="font-semibold text-lg" data-v-051ce2d7> Фильтры `);
      ...
      if (unref(filterTypesError)) {
        _push(`<div class="error-filter-types" data-v-051ce2d7><span data-v-051ce2d7>Ошибка загрузки фильтров</span></div>`);
      } else {
        _push(`<div class="overflow-auto" data-v-051ce2d7><div class="filter-section p-5" data-v-051ce2d7><h4 data-v-051ce2d7>Тип недвижимости</h4><div class="button-group" data-v-051ce2d7><!--[-->`);
        ...
        _push(`<!--]--></div></div><div class="filter-sections" data-v-051ce2d7>`);
        if (!unref(isHouse)) {
          _push(`<div class="filter-section" data-v-051ce2d7><h4 data-v-051ce2d7>Тип объекта</h4><div class="button-group" data-v-051ce2d7><!--[-->`);
          ...
          if (unref(filters).is_new_house) {
            _push(`<h4 data-v-051ce2d7>Дополнительно</h4>`);
          } else {
            _push(`<!---->`);
          }
          if (unref(filters).is_new_house) {
        ...
        _push(`<div class="filter-section" data-v-051ce2d7><h4 data-v-051ce2d7>Цена</h4><div class="button-group flex-col" data-v-051ce2d7>`);
        ...
        _push(`</div><div class="button-group flex-col" data-v-051ce2d7>`);
        _push(ssrRenderComponent(_component_UInput, {
        ...
        _push(`</div></div><div class="filter-section" data-v-051ce2d7><h4 data-v-051ce2d7>Площадь (м²)</h4><div class="button-group flex-col" data-v-051ce2d7>`);
        _push(ssrRenderComponent(_component_UInput, {
        ...
        _push(`</div>`);
        if (!unref(isHouse)) {
          _push(`<div class="button-group flex-col" data-v-051ce2d7>`);
          _push(ssrRenderComponent(_component_UInput, {
        ...
        _push(`</div>`);
        if (!unref(isFlat)) {
          _push(`<div class="filter-section" data-v-051ce2d7><h4 data-v-051ce2d7>Площадь участка (сот.)</h4><div class="button-group flex-col" data-v-051ce2d7>`);
          _push(ssrRenderComponent(_component_UInput, {
        ...
        if (!unref(isFlat)) {
          _push(`<div class="filter-section" data-v-051ce2d7><h4 data-v-051ce2d7>Спальни</h4><div class="button-group" data-v-051ce2d7><!--[-->`);
        ...
        if (!unref(isHouse)) {
          _push(`<div class="filter-section" data-v-051ce2d7><h4 data-v-051ce2d7>Комнаты</h4><div class="button-group" data-v-051ce2d7><!--[-->`);
        ...
        _push(`<div class="filter-section" data-v-051ce2d7><h4 data-v-051ce2d7>Этажи</h4>`);
        if (!unref(isHouse)) {
          _push(`<div class="button-group flex-col" data-v-051ce2d7>`);
          _push(ssrRenderComponent(_component_UInput, {
        ...
        _push(`</div></div>`);
        if (!unref(isHouse)) {
          _push(`<div class="filter-section" data-v-051ce2d7>`);
          if (unref(filters).is_new_house) {
            _push(`<h4 data-v-051ce2d7>Тип отделки</h4>`);
          } else if (unref(filters).is_new_house === false) {
            _push(`<h4 data-v-051ce2d7>Тип ремонта</h4>`);
          } else if (unref(filters).is_new_house == null) {
            _push(`<h4 data-v-051ce2d7>Тип ремонта/отделки</h4>`);
          } else {
            _push(`<!---->`);
          }
          _push(`<div class="button-group" data-v-051ce2d7><!--[-->`);
        ...
        _push(`<div class="filter-section" data-v-051ce2d7><h4 data-v-051ce2d7>Тип санузла</h4><div class="button-group" data-v-051ce2d7><!--[-->`);
        ...
        _push(`<!--]--></div></div>`);
        if (!unref(isFlat)) {
          _push(`<div class="filter-section" data-v-051ce2d7><h4 data-v-051ce2d7>Коммуникации</h4><div class="button-group flex-col" data-v-051ce2d7>`);
          _push(ssrRenderComponent(_component_UCheckbox, {
        ...
        _push(`<div class="filter-section" data-v-051ce2d7><h4 data-v-051ce2d7>Удобства</h4><div class="button-group flex-col" data-v-051ce2d7>`);
        if (!unref(isHouse)) {
          _push(`<!--[-->`);
          _push(ssrRenderComponent(_component_UCheckbox, {
        ...
        _push(`</div></div>`);
        if (!unref(isHouse)) {
          _push(`<div class="filter-section" data-v-051ce2d7><h4 data-v-051ce2d7>Вид из окон</h4><div class="button-group" data-v-051ce2d7><!--[-->`);
        ...
        if (!unref(isHouse)) {
          _push(`<div class="filter-section" data-v-051ce2d7><h4 data-v-051ce2d7>Тип парковки</h4><div class="button-group" data-v-051ce2d7><!--[-->`);
        ...
        _push(`<div class="filter-section" data-v-051ce2d7><h4 data-v-051ce2d7>Дополнительно</h4><div class="button-group flex-col" data-v-051ce2d7>`);
        _push(ssrRenderComponent(_component_UInput, {
        ...
        _push(`</div></div><div class="filter-section" data-v-051ce2d7>`);
        if (!unref(isFlat) && !unref(isHouse)) {
          _push(`<h4 data-v-051ce2d7>Тип/материал дома</h4>`);
        } else if (unref(isHouse)) {
          _push(`<h4 data-v-051ce2d7>Материал дома</h4>`);
        } else if (unref(isFlat)) {
          _push(`<h4 data-v-051ce2d7>Тип дома</h4>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<div class="button-group" data-v-051ce2d7><!--[-->`);
        ...
        _push(`<!--]--></div></div>`);
        if (!unref(isFlat)) {
          _push(`<div class="filter-section" data-v-051ce2d7><h4 data-v-051ce2d7>Тип участка</h4><div class="button-group" data-v-051ce2d7><!--[-->`);
        ...
        _push(`<div class="filter-section" data-v-051ce2d7><h4 data-v-051ce2d7>Тип отопления</h4><div class="button-group" data-v-051ce2d7><!--[-->`);
        ...
        _push(`<!--]--></div></div>`);
        if (unref(isHouse)) {
          _push(`<div class="filter-section" data-v-051ce2d7><h4 data-v-051ce2d7>Тип газоснабжения</h4><div class="button-group" data-v-051ce2d7><!--[-->`);
        ...
        if (unref(isHouse)) {
          _push(`<div class="filter-section" data-v-051ce2d7><h4 data-v-051ce2d7>Тип канализации</h4><div class="button-group" data-v-051ce2d7><!--[-->`);
        ...
        if (unref(isHouse)) {
          _push(`<div class="filter-section" data-v-051ce2d7><h4 data-v-051ce2d7>Тип водоснабжения</h4><div class="button-group" data-v-051ce2d7><!--[-->`);
        ...
        _push(`<div class="filter-section" data-v-051ce2d7><h4 data-v-051ce2d7>Категория цены</h4><div class="button-group" data-v-051ce2d7><!--[-->`);
        ...
        _push(`<!--]--></div></div><div class="filter-section" data-v-051ce2d7><h4 data-v-051ce2d7>Удобство для пожилых</h4><div class="button-group" data-v-051ce2d7><!--[-->`);
        ...
        _push(`<!--]--></div></div><div class="filter-section" data-v-051ce2d7><h4 data-v-051ce2d7>Удобство для семьи</h4><div class="button-group" data-v-051ce2d7><!--[-->`);
        ...
        _push(`<!--]--></div></div><div class="filter-section" data-v-051ce2d7><h4 data-v-051ce2d7>Транспортная доступность</h4><div class="button-group" data-v-051ce2d7><!--[-->`);
      ...
      _push(`<div class="filters-header" data-v-051ce2d7>`);
      _push(ssrRenderComponent(_component_UButton, {
...
const __nuxt_component_0 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$1, [["__scopeId", "data-v-051ce2d7"]]), { __name: "FiltersSidebar" });
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_UButton = _sfc_main$3;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "flex gap-2" }, _attrs))} data-v-cd37e8c8><div class="relative w-full" data-v-cd37e8c8><input${ssrRenderAttr("value", unref(searchQuery))} type="text" placeholder="Введите адрес для поиска недвижимости..." class="autocomplete-input" data-v-cd37e8c8>`);
      if (unref(showSuggestions) && unref(addressSuggestions) && unref(addressSuggestions).length > 0) {
        _push(`<ul class="suggestions-list" data-v-cd37e8c8><!--[-->`);
        ssrRenderList(unref(addressSuggestions), (suggestion, index) => {
          _push(`<li class="suggestion-item" data-v-cd37e8c8>${ssrInterpolate(suggestion)}</li>`);
        });
        _push(`<!--]--></ul>`);
      } else {
        _push(`<!---->`);
      ...
      if (unref(showSuggestions) && unref(searchQuery) && !unref(pending) && unref(addressSuggestions) && unref(addressSuggestions).length === 0) {
        _push(`<ul class="suggestions-list" data-v-cd37e8c8><li class="suggestion-item !cursor-default text-center text-muted hover:!bg-white" data-v-cd37e8c8> Адреса не найдены </li></ul>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
...
const __nuxt_component_1 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main, [["__scopeId", "data-v-cd37e8c8"]]), { __name: "AddressAutocomplete" });

export { __nuxt_component_0 as _, __nuxt_component_1 as a };
//# sourceMappingURL=AddressAutocomplete-BUzK95vI.mjs.map
