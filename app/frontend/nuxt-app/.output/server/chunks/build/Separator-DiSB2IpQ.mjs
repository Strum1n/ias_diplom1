...
import { _ as _sfc_main$2 } from './Avatar-Bz_JyLmu.mjs';
              ...
              __props.label || __props.icon || __props.avatar || !!slots.default ? (openBlock(), createBlock(Fragment, { key: 0 }, [
                createVNode("div", {
                  ...
                  renderSlot(_ctx.$slots, "default", { ui: ui.value }, () => [
                    ...
                    }, toDisplayString(__props.label), 3)) : __props.icon ? (openBlock(), createBlock(_sfc_main$1, {
                      key: 1,
                      name: __props.icon,
                      "data-slot": "icon",
                      class: ui.value.icon({ class: props.ui?.icon })
...
//# sourceMappingURL=Separator-DiSB2IpQ.mjs.map
