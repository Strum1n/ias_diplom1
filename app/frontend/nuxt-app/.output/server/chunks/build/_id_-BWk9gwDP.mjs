import { _ as _sfc_main$4 } from './Container-CHeSAjL4.mjs';
import { _ as _sfc_main$5 } from './Icon-CX2WwP6o.mjs';
import { defineComponent, shallowRef, ref, useTemplateRef, withAsyncContext, computed, watch, resolveComponent, withCtx, unref, createVNode, createTextVNode, toDisplayString, createBlock, openBlock, Fragment, renderList, createCommentVNode, withModifiers, mergeProps, renderSlot, h, getCurrentInstance, toRaw, reactive, defineAsyncComponent, Text, Comment, useSSRContext } from 'vue';
...
import { _ as _sfc_main$8 } from './Button-C2DhPQmq.mjs';
import { _ as _export_sfc, d as useRoute, b as useNuxtApp, a as useAppConfig, n as navigateTo } from './server.mjs';
import { _ as _sfc_main$6 } from './Badge-Bw-ZtEh9.mjs';
import { _ as _sfc_main$7 } from './Accordion-CLGoNVah.mjs';
import { I as pascalCase, J as kebabCase, d as destr } from '../_/nitro.mjs';
import { find, html } from 'property-information';
import { f as flatUnwrap, n as nodeTextContent } from './node-w2HLPhiE.mjs';
import { u as useAsyncData, a as useNuxtData } from './asyncData-BG26t6Y0.mjs';
import { u as useMapState, _ as _sfc_main$G, a as _sfc_main$D, b as _sfc_main$E, f as _sfc_main$y, g as _sfc_main$n } from './useMapState-Er0loVNa.mjs';
...
const _sfc_main$1 = {
  ...
  async setup(__props) {
    ...
    const { data, refresh, error } = ([__temp, __restore] = withAsyncContext(async () => useAsyncData(key.value, async () => {
      ...
      const { parseMarkdown } = await import('./index-BjtnJ5zg.mjs');
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: offer, pending, error } = ([__temp, __restore] = withAsyncContext(() => useAsyncData(
      `offers/${offerId}`,
      () => $api(`offers/${offerId}`),
      {
        getCachedData: (key) => {
    ...
    const priceChartSeries = computed(() => {
      if (!offer.value?.price_history?.length) return null;
      const sortedHistory = [...offer.value.price_history].sort(
        (a, b) => new Date(a.changeTime).getTime() - new Date(b.changeTime).getTime()
      );
      return [{
        name: "Цена",
    ...
    const viewsChartSeries = computed(() => {
      if (!offer.value?.views_history?.length) return null;
      const sortedHistory = [...offer.value.views_history].sort(
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_UContainer, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (unref(pending)) {
              _push2(`<div class="flex justify-center items-center h-96" data-v-2235cdbe${_scopeId}>`);
              ...
              _push2(`<div class="text-red-500" data-v-2235cdbe${_scopeId}> Произошла ошибка при загрузке данных: ${ssrInterpolate(unref(error).message)}</div>`);
            } else if (!unref(offer)) {
              _push2(`<div class="text-gray-500" data-v-2235cdbe${_scopeId}> Объявление не найдено </div>`);
            } else {
              _push2(`<div class="offer-content" data-v-2235cdbe${_scopeId}><div data-v-2235cdbe${_scopeId}><span data-v-2235cdbe${_scopeId}>Опубликовано: ${ssrInterpolate(new Date(unref(offer).creation_date_source).toLocaleString("ru-RU", {
                ...
                hour: "2-digit",
                minute: "2-digit"
              }))}</span></div><div class="flex gap-12 mb-15" data-v-2235cdbe${_scopeId}><div class="max-w-200" data-v-2235cdbe${_scopeId}><div data-v-2235cdbe${_scopeId}><h1 class="text-4xl font-bold my-3 text-black" data-v-2235cdbe${_scopeId}>${ssrInterpolate(unref(offer).title)}</h1></div><div class="text-muted my-4" data-v-2235cdbe${_scopeId}>${ssrInterpolate(unref(offer).address.full_address)} <a class="map-link" data-v-2235cdbe${_scopeId}>На карте</a></div><div class="gallery-section" data-v-2235cdbe${_scopeId}><div class="flex-1 w-full" data-v-2235cdbe${_scopeId}>`);
              _push2(ssrRenderComponent(_component_UCarousel, {
                ...
                default: withCtx(({ item }, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<img${ssrRenderAttr("src", item)} width="2000" height="480" class="rounded-lg" data-v-2235cdbe${_scopeId2}>`);
                  } else {
                    return [
                      createVNode("img", {
                        src: item,
              ...
              _push2(`<div class="scrlbrwdthnn flex gap-3 max-w-200 overflow-x-auto whitespace-nowrap pt-4 mx-auto" data-v-2235cdbe${_scopeId}><!--[-->`);
              ssrRenderList(unref(offer).images_urls, (item, index) => {
                _push2(`<div class="${ssrRenderClass([{ "opacity-100": activeIndex.value === index }, "sas h-15 opacity-35 hover:opacity-100 transition-opacity"])}" data-v-2235cdbe${_scopeId}><img${ssrRenderAttr("src", item)} width="78" height="100" class="rounded-lg" data-v-2235cdbe${_scopeId}></div>`);
              });
              _push2(`<!--]--></div></div></div><div class="info-card" data-v-2235cdbe${_scopeId}><h3 class="!mt-0" data-v-2235cdbe${_scopeId}>Оценки</h3><div class="categories-grid" data-v-2235cdbe${_scopeId}><div class="category-item" data-v-2235cdbe${_scopeId}><span class="category-label" data-v-2235cdbe${_scopeId}>Для пожилых:</span>`);
              ...
              _push2(`</div><div class="category-item" data-v-2235cdbe${_scopeId}><span class="category-label" data-v-2235cdbe${_scopeId}>Для семьи:</span>`);
              _push2(ssrRenderComponent(_component_UBadge, {
                size: "lg",
              ...
              _push2(`</div><div class="category-item" data-v-2235cdbe${_scopeId}><span class="category-label" data-v-2235cdbe${_scopeId}>Транспортная доступность:</span>`);
              _push2(ssrRenderComponent(_component_UBadge, {
                size: "lg",
              ...
              _push2(`</div></div><h3 class="!mb-0" data-v-2235cdbe${_scopeId}>Описание</h3>`);
              ...
              if (["Квартира", "Апартаменты"].includes(unref(offer).property_type.name)) {
                _push2(`<div class="flex gap-10" data-v-2235cdbe${_scopeId}><div class="flex-1" data-v-2235cdbe${_scopeId}><h3 class="!mt-0" data-v-2235cdbe${_scopeId}>О квартире</h3><div class="info-grid" data-v-2235cdbe${_scopeId}><div class="info-item" data-v-2235cdbe${_scopeId}><span class="label" data-v-2235cdbe${_scopeId}>Тип:</span>`);
                if (unref(offer).is_new_house) {
                  _push2(`<span class="value" data-v-2235cdbe${_scopeId}>Новостройка</span>`);
                } else {
                  _push2(`<span class="value" data-v-2235cdbe${_scopeId}>Вторичка</span>`);
                }
                _push2(`</div>`);
                if (unref(offer).rooms_count > 0 && unref(offer).rooms_count < 10) {
                  _push2(`<div class="info-item" data-v-2235cdbe${_scopeId}><span class="label" data-v-2235cdbe${_scopeId}>Кол-во комнат:</span><span class="value" data-v-2235cdbe${_scopeId}>${ssrInterpolate(unref(offer).rooms_count)}</span></div>`);
                } else {
                  _push2(`<!---->`);
                }
                _push2(`<div class="info-item" data-v-2235cdbe${_scopeId}><span class="label" data-v-2235cdbe${_scopeId}>Общая площадь:</span><span class="value" data-v-2235cdbe${_scopeId}>${ssrInterpolate(unref(offer).total_area)} м²</span></div>`);
                if (unref(offer).living_area) {
                  _push2(`<div class="info-item" data-v-2235cdbe${_scopeId}><span class="label" data-v-2235cdbe${_scopeId}>Жилая площадь:</span><span class="value" data-v-2235cdbe${_scopeId}>${ssrInterpolate(unref(offer).living_area)} м²</span></div>`);
                } else {
                  _push2(`<!---->`);
                }
                if (unref(offer).kitchen_area) {
                  _push2(`<div class="info-item" data-v-2235cdbe${_scopeId}><span class="label" data-v-2235cdbe${_scopeId}>Площадь кухни:</span><span class="value" data-v-2235cdbe${_scopeId}>${ssrInterpolate(unref(offer).kitchen_area)} м²</span></div>`);
                } else {
                  _push2(`<!---->`);
                }
                if (unref(offer).ceiling_height) {
                  _push2(`<div class="info-item" data-v-2235cdbe${_scopeId}><span class="label" data-v-2235cdbe${_scopeId}>Высота потолков:</span><span class="value" data-v-2235cdbe${_scopeId}>${ssrInterpolate(unref(offer).ceiling_height)} м</span></div>`);
                } else {
                  _push2(`<!---->`);
                }
                if (unref(offer).bathrooms_count) {
                  _push2(`<div class="info-item" data-v-2235cdbe${_scopeId}><span class="label" data-v-2235cdbe${_scopeId}>Кол-во санузлов:</span><span class="value" data-v-2235cdbe${_scopeId}>${ssrInterpolate(unref(offer).bathrooms_count)} ${ssrInterpolate(unref(offer).bathroom_type?.name)}</span></div>`);
                } else {
                  _push2(`<!---->`);
                }
                if (unref(offer).has_balcony) {
                  _push2(`<div class="info-item" data-v-2235cdbe${_scopeId}><span class="label" data-v-2235cdbe${_scopeId}>Балкон</span><span class="value" data-v-2235cdbe${_scopeId}>Есть</span></div>`);
                } else {
                  _push2(`<!---->`);
                }
                if (unref(offer).floor) {
                  _push2(`<div class="info-item" data-v-2235cdbe${_scopeId}><span class="label" data-v-2235cdbe${_scopeId}>Этаж:</span><span class="value" data-v-2235cdbe${_scopeId}>${ssrInterpolate(unref(offer).floor)}</span></div>`);
                } else {
                  _push2(`<!---->`);
                }
                if (unref(offer).window_view_type) {
                  _push2(`<div class="info-item" data-v-2235cdbe${_scopeId}><span class="label" data-v-2235cdbe${_scopeId}>Вид из окон:</span><span class="value" data-v-2235cdbe${_scopeId}>${ssrInterpolate(unref(offer).window_view_type?.name)}</span></div>`);
                } else {
                  _push2(`<!---->`);
                }
                if (unref(offer).renovation_type) {
                  _push2(`<div class="info-item" data-v-2235cdbe${_scopeId}>`);
                  if (unref(offer).is_new_house) {
                    _push2(`<span class="label" data-v-2235cdbe${_scopeId}>Отделка:</span>`);
                  } else {
                    _push2(`<span class="label" data-v-2235cdbe${_scopeId}>Ремонт:</span>`);
                  }
                  _push2(`<span class="value" data-v-2235cdbe${_scopeId}>${ssrInterpolate(unref(offer).renovation_type?.name)}</span></div>`);
                } else {
                  _push2(`<!---->`);
                }
                _push2(`</div></div><div class="flex-1" data-v-2235cdbe${_scopeId}><h3 class="!mt-0" data-v-2235cdbe${_scopeId}>О доме</h3><div class="info-grid" data-v-2235cdbe${_scopeId}>`);
                if (unref(offer).house_built_year) {
                  _push2(`<div class="info-item" data-v-2235cdbe${_scopeId}><span class="label" data-v-2235cdbe${_scopeId}>Год постройки:</span><span class="value" data-v-2235cdbe${_scopeId}>${ssrInterpolate(unref(offer).house_built_year)}</span></div>`);
                } else {
                  _push2(`<!---->`);
                }
                if (unref(offer).house_floors_count) {
                  _push2(`<div class="info-item" data-v-2235cdbe${_scopeId}><span class="label" data-v-2235cdbe${_scopeId}>Кол-во этажей:</span><span class="value" data-v-2235cdbe${_scopeId}>${ssrInterpolate(unref(offer).house_floors_count)}</span></div>`);
                } else {
                  _push2(`<!---->`);
                }
                if (unref(offer).elevators_count) {
                  _push2(`<div class="info-item" data-v-2235cdbe${_scopeId}><span class="label" data-v-2235cdbe${_scopeId}>Кол-во лифтов:</span><span class="value" data-v-2235cdbe${_scopeId}>${ssrInterpolate(unref(offer).elevators_count)}</span></div>`);
                } else {
                  _push2(`<!---->`);
                }
                if (unref(offer).house_material_type) {
                  _push2(`<div class="info-item" data-v-2235cdbe${_scopeId}><span class="label" data-v-2235cdbe${_scopeId}>Тип дома:</span><span class="value" data-v-2235cdbe${_scopeId}>${ssrInterpolate(unref(offer).house_material_type?.name)}</span></div>`);
                } else {
                  _push2(`<!---->`);
                }
                if (unref(offer).heating_type) {
                  _push2(`<div class="info-item" data-v-2235cdbe${_scopeId}><span class="label" data-v-2235cdbe${_scopeId}>Отопление:</span><span class="value" data-v-2235cdbe${_scopeId}>${ssrInterpolate(unref(offer).heating_type?.name)}</span></div>`);
                } else {
                  _push2(`<!---->`);
                }
                if (unref(offer).parking_type) {
                  _push2(`<div class="info-item" data-v-2235cdbe${_scopeId}><span class="label" data-v-2235cdbe${_scopeId}>Парковка:</span><span class="value" data-v-2235cdbe${_scopeId}>${ssrInterpolate(unref(offer).parking_type?.name)}</span></div>`);
                } else {
                  _push2(`<!---->`);
                }
                if (unref(offer).has_garbage_chute) {
                  _push2(`<div class="info-item" data-v-2235cdbe${_scopeId}><span class="label" data-v-2235cdbe${_scopeId}>Мусоропровод:</span><span class="value" data-v-2235cdbe${_scopeId}>Есть</span></div>`);
                } else {
                  _push2(`<!---->`);
                }
                _push2(`</div></div></div>`);
              } else {
                _push2(`<div data-v-2235cdbe${_scopeId}><div class="flex gap-10" data-v-2235cdbe${_scopeId}><div class="flex-1" data-v-2235cdbe${_scopeId}><h3 class="!mt-0" data-v-2235cdbe${_scopeId}>О доме</h3><div class="info-grid" data-v-2235cdbe${_scopeId}><div class="info-item" data-v-2235cdbe${_scopeId}><span class="label" data-v-2235cdbe${_scopeId}>Площадь:</span><span class="value" data-v-2235cdbe${_scopeId}>${ssrInterpolate(unref(offer).total_area)} м²</span></div>`);
                if (unref(offer).house_material_type) {
                  _push2(`<div class="info-item" data-v-2235cdbe${_scopeId}><span class="label" data-v-2235cdbe${_scopeId}>Материал дома:</span><span class="value" data-v-2235cdbe${_scopeId}>${ssrInterpolate(unref(offer).house_material_type?.name)}</span></div>`);
                } else {
                  _push2(`<!---->`);
                }
                if (unref(offer).house_floors_count) {
                ...
                if (unref(offer).bedrooms_count) {
                  _push2(`<div class="info-item" data-v-2235cdbe${_scopeId}><span class="label" data-v-2235cdbe${_scopeId}>Кол-во спален:</span><span class="value" data-v-2235cdbe${_scopeId}>${ssrInterpolate(unref(offer).bedrooms_count)}</span></div>`);
                } else {
                  _push2(`<!---->`);
                }
                if (unref(offer).house_built_year) {
                ...
                _push2(`</div></div><div class="flex-1" data-v-2235cdbe${_scopeId}><h3 class="!mt-0" data-v-2235cdbe${_scopeId}>Об участке</h3><div class="info-grid" data-v-2235cdbe${_scopeId}>`);
                if (unref(offer).land_area) {
                  _push2(`<div class="info-item" data-v-2235cdbe${_scopeId}><span class="label" data-v-2235cdbe${_scopeId}>Площадь</span><span class="value" data-v-2235cdbe${_scopeId}>${ssrInterpolate(unref(offer).land_area)} сот.</span></div>`);
                } else {
                  _push2(`<!---->`);
                }
                if (unref(offer).land_type) {
                  _push2(`<div class="info-item" data-v-2235cdbe${_scopeId}><span class="label" data-v-2235cdbe${_scopeId}>Статус участка</span><span class="value" data-v-2235cdbe${_scopeId}>${ssrInterpolate(unref(offer).land_type?.name)}</span></div>`);
                } else {
                  _push2(`<!---->`);
                }
                _push2(`</div></div></div><h3 data-v-2235cdbe${_scopeId}>Коммуникации и удобства</h3><div class="info-grid" data-v-2235cdbe${_scopeId}>`);
                if (unref(offer).bathrooms_count) {
                  _push2(`<div class="info-item" data-v-2235cdbe${_scopeId}><span class="label" data-v-2235cdbe${_scopeId}>Кол-во санузлов:</span><span class="value" data-v-2235cdbe${_scopeId}>${ssrInterpolate(unref(offer).bathrooms_count)} ${ssrInterpolate(unref(offer).bathroom_type?.name?.toLowerCase())}</span></div>`);
                } else {
                  _push2(`<!---->`);
                }
                if (unref(offer).sewerage_type) {
                  _push2(`<div class="info-item" data-v-2235cdbe${_scopeId}><span class="label" data-v-2235cdbe${_scopeId}>Канализация</span><span class="value" data-v-2235cdbe${_scopeId}>${ssrInterpolate(unref(offer).sewerage_type?.name)}</span></div>`);
                } else {
                  _push2(`<!---->`);
                }
                if (unref(offer).water_supply_type) {
                  _push2(`<div class="info-item" data-v-2235cdbe${_scopeId}><span class="label" data-v-2235cdbe${_scopeId}>Водоснабжение</span><span class="value" data-v-2235cdbe${_scopeId}>${ssrInterpolate(unref(offer).water_supply_type?.name)}</span></div>`);
                } else {
                  _push2(`<!---->`);
                }
                if (unref(offer).heating_type) {
                ...
                if (unref(offer).has_electricity) {
                  _push2(`<div class="info-item" data-v-2235cdbe${_scopeId}><span class="label" data-v-2235cdbe${_scopeId}>Электричество</span><span class="value" data-v-2235cdbe${_scopeId}>Есть</span></div>`);
                } else {
                  _push2(`<!---->`);
                }
                if (unref(offer).gas_type) {
                  _push2(`<div class="info-item" data-v-2235cdbe${_scopeId}><span class="label" data-v-2235cdbe${_scopeId}>Газ</span><span class="value" data-v-2235cdbe${_scopeId}>${ssrInterpolate(unref(offer).gas_type?.name)}</span></div>`);
                } else {
                  _push2(`<!---->`);
                }
                if (unref(offer).has_garage || unref(offer).has_terrace || unref(offer).has_bathhouse || unref(offer).has_pool) {
                  _push2(`<div class="info-item !items-start" data-v-2235cdbe${_scopeId}><span class="label" data-v-2235cdbe${_scopeId}>Дополнительно</span><div class="flex flex-col gap-1" data-v-2235cdbe${_scopeId}>`);
                  if (unref(offer).has_garage) {
                    _push2(`<span class="value" data-v-2235cdbe${_scopeId}>Гараж</span>`);
                  } else {
                    _push2(`<!---->`);
                  }
                  if (unref(offer).has_terrace) {
                    _push2(`<span class="value" data-v-2235cdbe${_scopeId}>Терраса</span>`);
                  } else {
                    _push2(`<!---->`);
                  }
                  if (unref(offer).has_bathhouse) {
                    _push2(`<span class="value" data-v-2235cdbe${_scopeId}>Баня</span>`);
                  } else {
                    _push2(`<!---->`);
                  }
                  if (unref(offer).has_pool) {
                    _push2(`<span class="value" data-v-2235cdbe${_scopeId}>Бассейн</span>`);
                  } else {
                    _push2(`<!---->`);
                  }
                  _push2(`</div></div>`);
              ...
              _push2(`</div><div class="map-placeholder" data-v-2235cdbe${_scopeId}><h3 data-v-2235cdbe${_scopeId}>Расположение</h3>`);
                  ...
                  if (_push3) {
                    ...
                    _push3(ssrRenderComponent(unref(_sfc_main$y), {
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<div class="house-marker" data-v-2235cdbe${_scopeId3}><svg class="marker-svg" data-name="Pin" width="54" height="54" viewBox="0 0 54 54" fill="none" xmlns="http://www.w3.org/2000/svg" data-v-2235cdbe${_scopeId3}><path d="M27 0C16.507 0 8 8.507 8 19C8 30.6644 19.5164 38.5163 27 46C34.4076 38.5197 46 30.622 46 19C46 8.507 37.493 0 27 0Z" data-v-2235cdbe${_scopeId3}></path><path fill-rule="evenodd" clip-rule="evenodd" d="M27 33C34.7317 33 41 26.7317 41 19C41 11.2683 34.7317 5 27 5C19.2683 5 13 11.2683 13 19C13 26.7317 19.2683 33 27 33Z" fill="white" data-v-2235cdbe${_scopeId3}></path><path fill-rule="evenodd" clip-rule="evenodd" d="M33.4665 19.5633V12.2365H30.2323V15.6778L27.0001 11.7947L18 22.6071L20.9939 25.099L27.0001 17.8834L33.0061 25.099L36 22.6071L33.4665 19.5633Z" data-v-2235cdbe${_scopeId3}></path><circle cx="27" cy="50" r="3" fill="white" data-v-2235cdbe${_scopeId3}></circle><circle cx="27" cy="50" r="2" data-v-2235cdbe${_scopeId3}></circle></svg></div>`);
                        } else {
                          return [
                    ...
                    ssrRenderList(markers.value, (marker, index) => {
                      _push3(ssrRenderComponent(unref(_sfc_main$y), {
                        ...
                        default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                          if (_push4) {
                            _push4(`<div class="marker" data-v-2235cdbe${_scopeId3}>`);
                    ...
                    _push3(ssrRenderComponent(unref(_sfc_main$n), { "hint-property": "hint" }, {
                      default: withCtx(({ content }, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<div class="hint" data-v-2235cdbe${_scopeId3}>${content ?? ""}</div>`);
                        } else {
                          return [
                            createVNode("div", {
                              class: "hint",
              ...
              _push2(`</div><div class="infrastructure-section" data-v-2235cdbe${_scopeId}><h3 data-v-2235cdbe${_scopeId}>Ближайшая инфраструктура</h3><div class="infrastructure-list" data-v-2235cdbe${_scopeId}><!--[-->`);
              ssrRenderList(getClosestInfrastructure(unref(offer)), (infra) => {
                _push2(`<div class="infrastructure-item" data-v-2235cdbe${_scopeId}>`);
                _push2(ssrRenderComponent(_component_UIcon, {
                  size: "20",
                  name: getInfrastructureIcon(infra.infrastructure.infrastructure_type.id)
                }, null, _parent2, _scopeId));
                if (infra.infrastructure.name !== "unknown") {
                  _push2(`<div class="infra-info" data-v-2235cdbe${_scopeId}><span class="infra-type" data-v-2235cdbe${_scopeId}>${ssrInterpolate(infra.infrastructure.infrastructure_type.name)}</span><span class="infra-type font-semibold !text-black" data-v-2235cdbe${_scopeId}>${ssrInterpolate(infra.infrastructure.name)}</span></div>`);
                } else {
                  _push2(`<div class="infra-info" data-v-2235cdbe${_scopeId}><span class="infra-type" data-v-2235cdbe${_scopeId}>${ssrInterpolate(infra.infrastructure.infrastructure_type.name)}</span></div>`);
                }
                _push2(`<span class="infra-distance" data-v-2235cdbe${_scopeId}>${ssrInterpolate(infra.distance)} м</span></div>`);
              });
              _push2(`<!--]--></div></div></div><div class="flex-1" data-v-2235cdbe${_scopeId}><div class="sticky top-17" data-v-2235cdbe${_scopeId}><div class="contact-card rounded-md" data-v-2235cdbe${_scopeId}><div class="price-section" data-v-2235cdbe${_scopeId}><div class="price" data-v-2235cdbe${_scopeId}><p class="flex gap-4 items-center" data-v-2235cdbe${_scopeId}>${ssrInterpolate(formatPrice(unref(offer).price))} ₽ `);
              _push2(ssrRenderComponent(_component_UBadge, {
                size: "lg",
              ...
              _push2(`</p><button class="${ssrRenderClass([{ active: isFavorite(unref(offer).id) }, "favorite-heart"])}" data-v-2235cdbe${_scopeId}>`);
              _push2(ssrRenderComponent(_component_UIcon, {
                size: "30",
                name: isFavorite(unref(offer).id) ? "material-symbols-light:favorite" : "material-symbols-light:favorite-outline",
                class: "heart-icon"
              }, null, _parent2, _scopeId));
              _push2(`</button></div><div class="price-per-meter" data-v-2235cdbe${_scopeId}><span data-v-2235cdbe${_scopeId}>Цена за метр:</span><span class="font-semibold !text-[#38a169]" data-v-2235cdbe${_scopeId}>${ssrInterpolate(formatPrice(unref(offer).price_per_square_meter))} ₽/м²</span></div></div><div class="contacts" data-v-2235cdbe${_scopeId}><h3 class="mt-2 mb-3" data-v-2235cdbe${_scopeId}>Контакты:</h3><div class="phone-number" data-v-2235cdbe${_scopeId}>${ssrInterpolate(formatPhone(unref(offer).contact_phone))}</div><div class="seller-info" data-v-2235cdbe${_scopeId}><div class="seller-type" data-v-2235cdbe${_scopeId}>${ssrInterpolate(unref(offer).seller.seller_type.name)}</div><div class="seller-name" data-v-2235cdbe${_scopeId}>${ssrInterpolate(unref(offer).seller.name)}</div></div><div class="original-link" data-v-2235cdbe${_scopeId}>`);
              _push2(ssrRenderComponent(_component_UIcon, {
                size: "18",
                name: "i-heroicons-link"
              }, null, _parent2, _scopeId));
              _push2(`<a target="_blank"${ssrRenderAttr("href", unref(offer).url)} data-v-2235cdbe${_scopeId}>Оригинальное объявление</a></div></div></div>`);
              if (unref(offer).price_history.length > 1) {
                _push2(`<div class="price-history-section" data-v-2235cdbe${_scopeId}><h3 data-v-2235cdbe${_scopeId}>История цен</h3>`);
                if (priceChartOptions.value && priceChartSeries.value) {
                  _push2(`<div data-v-2235cdbe${_scopeId}>`);
                  ...
                  _push2(`<div class="no-data" data-v-2235cdbe${_scopeId}> Нет данных по истории цен </div>`);
                }
                _push2(`</div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`<div class="views-section" data-v-2235cdbe${_scopeId}><h3 data-v-2235cdbe${_scopeId}>Статистика просмотров</h3><div class="views-stats" data-v-2235cdbe${_scopeId}><div class="stat-item" data-v-2235cdbe${_scopeId}><span class="stat-label" data-v-2235cdbe${_scopeId}>Всего:</span><span class="stat-value" data-v-2235cdbe${_scopeId}>${ssrInterpolate(unref(offer).views_count)}</span></div><div class="stat-item" data-v-2235cdbe${_scopeId}><span class="stat-label" data-v-2235cdbe${_scopeId}>10 дней:</span><span class="stat-value" data-v-2235cdbe${_scopeId}>${ssrInterpolate(unref(offer).last_ten_days_views_count)}</span></div><div class="stat-item" data-v-2235cdbe${_scopeId}><span class="stat-label" data-v-2235cdbe${_scopeId}>Сегодня:</span><span class="stat-value" data-v-2235cdbe${_scopeId}>${ssrInterpolate(unref(offer).daily_views_count)}</span></div></div></div>`);
              if (viewsChartOptions.value && viewsChartSeries.value) {
                _push2(`<div class="chart-container" data-v-2235cdbe${_scopeId}>`);
                _push2(ssrRenderComponent(_component_apexchart, {
                  type: "line",
                  height: "328",
                ...
                _push2(`<div class="no-data" data-v-2235cdbe${_scopeId}> Нет данных по истории просмотров </div>`);
              }
                ...
                createVNode("div", { class: "flex gap-12 mb-15" }, [
                  ...
                  createVNode("div", { class: "flex-1" }, [
                    createVNode("div", { class: "sticky top-17" }, [
                      createVNode("div", { class: "contact-card rounded-md" }, [
                        ...
                        createVNode("div", { class: "contacts" }, [
                          ...
                          createVNode("div", { class: "phone-number" }, toDisplayString(formatPhone(unref(offer).contact_phone)), 1),
                          ...
                          createVNode("div", { class: "original-link" }, [
                            ...
                            }, "Оригинальное объявление", 8, ["href"])
                          ])
                        ])
                      ]),
...
const _id_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-2235cdbe"]]);
...
//# sourceMappingURL=_id_-BWk9gwDP.mjs.map
