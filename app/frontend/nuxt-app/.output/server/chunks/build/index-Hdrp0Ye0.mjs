...
import { R as defu, U as kebabCase } from '../_/nitro.mjs';
...
import { h as htmlTags } from './_id_-ma23IRGa.mjs';
...
import './useLocale-CKG--c2g.mjs';
import './index-CED3XvSe.mjs';
import './Button-BL6TDcLa.mjs';
...
import './Badge-DNgMi0Nd.mjs';
import './Accordion-C9a19AXB.mjs';
import 'property-information';
import './useMapState-Dc87w07T.mjs';
...
const createParseProcessor = async (inlineOptions = {}) => {
  if (!moduleOptions) {
    moduleOptions = await import(
      './virtual_nuxt_G__My_Programs_ias_diplom1_app_frontend_nuxt-app_node_modules_.cache_nuxt_.nuxt_mdc-imports-BJzUit9Q.mjs'
      /* @vite-ignore */
    ).catch(() => ({}));
  }
  if (!generatedMdcConfigs) {
    generatedMdcConfigs = await import(
      './virtual_nuxt_G__My_Programs_ias_diplom1_app_frontend_nuxt-app_node_modules_.cache_nuxt_.nuxt_mdc-configs-D-mPnyQ5.mjs'
      /* @vite-ignore */
...
//# sourceMappingURL=index-Hdrp0Ye0.mjs.map
